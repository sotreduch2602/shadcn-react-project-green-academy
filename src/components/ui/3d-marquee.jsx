...
export const ThreeDMarquee = ({ images, className }) => {
  ...
  return (
    <div
      className={cn(
        "mx-auto block h-[600px] overflow-hidden bg-sky-800 max-sm:h-100",
        className
      )}
    >
                ...
                {subarray.map((image, imageIndex) => (
                  <div className="relative" key={imageIndex + image}>
                    ...
                    <motion.img
                      ...
                      className="aspect-[970/700] rounded-lg object-contain bg-white ring-2 ring-gray-950/5 hover:shadow-2xl"
                      width={970}
                      height={700}
                    />
                  </div>
